...
func TestAllMetrics(t *testing.T) {
	...
	assert.Contains(t, w.Body.String(), `nest_online{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom Name",room="Living Room"} 1`)
	assert.Contains(t, w.Body.String(), `nest_setpoint_temperature_celsius{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom Name",room="Living Room"} 19.17838`)
	...
	assert.Contains(t, w.Body.String(), `nest_mode_heatcool{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",room="Living Room"} 0`)
	assert.Contains(t, w.Body.String(), `nest_mode_cool{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",room="Living Room"} 0`)
	assert.Contains(t, w.Body.String(), `nest_mode_off{id="enterprises/PROJECT_ID/devices/DEVICE_ID",label="Custom-Name",room="Living Room"} 0`)
